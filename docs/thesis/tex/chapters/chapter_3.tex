...
To test my cluster, I will be utilising the Eggholder function. I intend on searching the full search-space at all times, adapting the precision to increase or decrease computational expense. This, combined with increasing and decreasing the node count will give me a suitable data-set with which I can scientifically analyse.
